...
class LifecycleSubscriber implements EventSubscriberInterface
{
    ...
    public function install(GenericEvent $event)
    {
        ...
        $this->preferences->set('YoutubeBaseUrl', 'https://www.googleapis.com/youtube/v3/');
        $this->preferences->set('YoutubeFields', 'items(contentDetails,id,snippet),nextPageToken,pageInfo,tokenPagination');
    ...
    {
        return array(
            'plugin.install.newscoop_youtube_plugin_bundle' => array('install', 1),
            'plugin.update.newscoop_youtube_plugin_bundle' => array('update', 1),
            'plugin.remove.newscoop_youtube_plugin_bundle' => array('remove', 1),
        );
    }
